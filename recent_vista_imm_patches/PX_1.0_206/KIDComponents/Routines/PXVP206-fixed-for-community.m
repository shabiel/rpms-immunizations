PXVP206 ;BPOIFO/CLR - POST INSTALL ;2015-05-08  8:53 AM
...
PRE ;
 ; VEN/SMH START
 ; I $G(DUZ("AG"))'="V" Q ; VEN/SMH - Must run for people outside the VA.
 ; VEN/SMH END
 N PXVI,PXVNM,I,PXVC
...
POST ;Post installation
 ...
 ;
 ; VEN/SMH - START At this point, every thing is done except STS updates.
 ; People outside the VA do not need that.
 I $G(DUZ("AG"))'="V" Q
 ; VEN/SMH - END
