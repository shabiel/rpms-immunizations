BIENVCHK ;IHS/CMI/MWR - ENVIRONMENTAL CHECK FOR KIDS; DEC 15, 2010
 ...
 ;;  PATCH 8, v8.5: Check environment for Imm v8.5 Patch 7.  START+53
 ;
 ;
 ;----------
START ;EP
 ...
 .;---> Patch 5.
 .I $P(X,U)'=7&($P(X,U)'>7) D  S XPDQUIT=2
 ..W !,$$CJ^XLFSTR("BI v8.5 Patch 7 NOT INSTALLED",IOM)
 .;
 .I XPDQUIT'=2 D
 ...
 ..W !,$$CJ^XLFSTR("Checking for Patch 7 of BI v8.5...Patch 7 Present",IOM)
 ;**********
 ;
