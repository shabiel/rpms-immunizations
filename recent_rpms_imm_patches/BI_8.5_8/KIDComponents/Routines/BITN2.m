BITN2 ;IHS/CMI/MWR - BUILD ^BITN GLOBAL SECOND HALF.
 ...
 ;;  PATCH 8: Added Related Contras for Pneumos, and Combo for MenCY-Hib, 148.
 ;
 ;
 ;----------
TABLE ; EP
 ...
 ;;235;;Pneumococcal, PCV-13^PCV-13^133^^^^0^0^11^PCV13^90670^33,100,109,133^3100416^^^0^1^.5
